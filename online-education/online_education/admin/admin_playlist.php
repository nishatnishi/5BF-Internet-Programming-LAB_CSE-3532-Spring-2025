...
<section class="playlists">
   ...
   <div class="box-container">
      ...
      <div class="box" style="text-align: center;">
         ...
         <a href="create_playlist.php" class="btn">add playlist</a>
      </div>
<!--ei tutor er shob playlist niye nicche -->
      ...
      <div class="box">
         ...
         <form action="" method="post" class="flex-btn">
            ...
            <a href="ad_update_playlist.php?get_id=<?= $playlist_id; ?>" class="option-btn">update</a>
            <input type="submit" value="delete" class="delete-btn" onclick="return confirm('delete this playlist?');" name="delete">
         </form>
         <a href="full_playlist.php?get_id=<?= $playlist_id; ?>" class="btn">view playlist</a>
      </div>
      <?php
         } 
      }else{
