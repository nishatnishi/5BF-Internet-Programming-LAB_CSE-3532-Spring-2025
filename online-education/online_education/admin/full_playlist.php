    ...
    <div class="row">
      ...
      <div class="details">
         ...
         <form action="" method="post" class="flex-btn">
            ...
            <a href="ad_update_playlist.php?get_id=<?= $playlist_id; ?>" class="option-btn">update playlist</a>
   ...
   ?>
      <div class="box">
         ...
         <form action="" method="post" class="flex-btn">
            ...
            <a href="ad_update_playlist.php" class="option-btn">update</a>
            <input type="submit" value="delete" class="delete-btn" onclick="return confirm('delete this video?');" name="delete_video">
         </form>
         <a href="total_contents.php?get_id=<?= $video_id; ?>" class="btn">watch video</a>
      </div>
   <?php
         }
      }else{
         echo '<p class="empty">no videos added yet! <a href="create_contents.php" class="btn" style="margin-top: 1.5rem;">add videos</a></p>';
      }
   ?>
